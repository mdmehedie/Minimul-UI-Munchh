              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { id, couponCode, discountType, amount, startDate, expireDate, status,  createAt } = row;
                      const isItemSelected = selected.indexOf(couponCode) !== -1;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left"> {discountType} </TableCell>
